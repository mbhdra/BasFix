...
<html lang="en" dir="ltr">
  ...
  <body class="bg-secondary bg-opacity-25">
    ...
    <br><br><br><br><br><br>
    <form action="addSportsHall" method="post">
      <div class="row justify-content-center ">
        <div class="col-4 border p-3 bg-light">

          <div class="form-group pb-3">
            <label for="sportsHallName">Sports Hall Name:</label>
            <input type="text" name="sportsHallName" class="form-control" id="sportsHallName" placeholder="Sports Hall Name" required>
          </div>
